...
// export default class AskClients extends Component {
//   constructor(props) {
//     super(props);
...
//   //     const currentUser = await AuthService.getAllUsers();
//   //     const filteredData = letterData.filter(
//   //       (record) => record.priority === "DPH" && record.es_locnid === currentUser.username
//   //     );
...
//       // Ensure that currentUser and currentUser.username are defined before using slice
//       const brcds = currentUser.username.slice(1);
  
//       if (!brcds) {
//         window.alert("Username not found or invalid.");
