...
function model(sequelize) {
  const attributes = {
    ...
    terminal_id :{type: DataTypes.STRING(225) , allowNull: true},
    ...
    tradable_lot :{type: DataTypes.FLOAT , allowNull: true},
    quantity_multiplier :{type: DataTypes.FLOAT , allowNull: true},
    price_multiplier :{type: DataTypes.FLOAT , allowNull: true},
    quantity_unit :{type: DataTypes.STRING(225) , allowNull: true},
    price_unit :{type: DataTypes.STRING(225) , allowNull: true},
    parent_record_id :{type: DataTypes.FLOAT , allowNull: true},
    amd_date :{type: DataTypes.STRING(225) , allowNull: true},
    row_version :{type: DataTypes.FLOAT , allowNull: true},
    trade_classification_flag :{type: DataTypes.FLOAT , allowNull: true},
  ...
  */
  ...
  return sequelize.define("saudabookcom", attributes, options);
}
