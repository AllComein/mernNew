  ...
  generalExcel = (record) => {
    const data = [
      ...
      [
        ...
        record.ks_panno, record.ks_emailid, record.ks_mobile, record.ks_dpid, record.ksdp_boid,
        record.vir_bkacno,
