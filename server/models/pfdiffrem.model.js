...
user_data : {type: DataTypes.STRING(225) , allowNull: true},
user_date : {type: DataTypes.STRING(225) , allowNull: true},
  ...
  */
  ...
  return sequelize.define("pfdiffrems", attributes, options);
}
