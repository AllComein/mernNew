...
const Record = (props) => (
 ...
 export default function RunningAccLetters() {
...
useEffect(() => {
  async function getRecords() {
    ...
    try {
      ...
      const filterRecords = records.filter(record =>  viewableUsers.includes(record.es_locnid));
      // const filterRecords = records.filter(record => record.es_locnid === currentusername.username)
